...
var Oled = function(opts) {
  ...
  this.SEG_REMAP = 0xA0;    // using 0xA1 will flip screen
  this.COM_SCAN_DEC = 0xC0; // using 0xC8 will flip screen
...
Oled.prototype.drawBitmap = function(pixels, width, sync) {
  var immed = (typeof sync === 'undefined') ? true : sync;
  var x, y,
      pixelArray = [];
  ...
  for (var i = 0; i < pixels.length; i++) {
    ...
    this.drawPixel([x + this.cursor_x, y + this.cursor_y, pixels[i]], false);
  }
